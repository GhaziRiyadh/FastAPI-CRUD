...
from src.core.response.handlers import (
    success_response,
    paginated_response,
    error_response,
)
...
class BaseRouter:
    ...
    def _register_get_by_id(self) -> None:
        ...
        async def get_by_id(
            ...
            include_deleted: bool = Query(
                False, description="Include soft deleted items"
            ),
        ):
            try:
    ...
    def _register_create(self) -> None:
        ...
        async def create_item(
            item_data: self.create_schema, request: Request  # type: ignore
        ):
            try:
    ...
    def _register_update(self) -> None:
        ...
        async def update_item(
            item_id: int, item_data: self.update_schema  # type: ignore
        ):
            try:
    ...
    def _register_count(self) -> None:
        ...
        async def count_items(include_deleted: bool = Query(False)):
            try:
    ...
    def _register_exists(self) -> None:
        ...
        async def check_exists(item_id: int, include_deleted: bool = Query(False)):
            try:
    ...
    def _register_bulk_create(self) -> None:
        ...
        async def bulk_create_items(
            items_data: BulkCreateSchema, request: Request  # type: ignore
        ):
            try:
    ...
    def _register_bulk_update(self) -> None:
        ...
        async def bulk_update_items(items_data: BulkUpdateSchema):  # type: ignore
            try:
                update_list = [
    ...
    def add_custom_route(
        self, path: str, method: str, endpoint: Callable, **kwargs
    ) -> None:
    ...
    def _register_field_routes(self):
        ...
        @self.router.get("/model/schemas", summary="Get model schemas for frontend")
